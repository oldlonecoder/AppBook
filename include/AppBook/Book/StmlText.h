 ...
 *
    \code
        Book::Enums::Code Test::TestText()
        {
            ...
            try{
                RawText = "<fb:Reset; f:Yellow; Icon:Home;> Salut <b:Reset F:White;  f:yellow;> &agrave; <fb:reset;>Toi!";
                auto RetCode = RawText << Text >> EncodedText;
...
public:
    ...
    std::string InputText() { return _InputText; }
...
private:
    ...
    struct Compiler
    {
        ...
        enum class Context : uint8_t {
            Out,        ///< In outside context Status ( normal STMLText ) - Begin Seq is Expected
            ...
            InAttr,     ///< in Attr Seq, requires BeginAttr current Status.
        ...
        void CloseToken(STMLToken& Info);
